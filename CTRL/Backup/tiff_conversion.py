...
def manage_tiff(wk_dir, fd_list, dfd_list, tiff_loc, fm_dict, dm_dict):
    '''
    copy and rename tiff files from DECOMP service to Tiff Location
    
    '''
    for folder in dfd_list:
        ...
        if tifffiles:  
            ...
            for tiff_file in tifffiles:
                copyfile(tiff_file, tiff_loc + dm_dict[tiff_file])
#                os.remove(tiff_file)
